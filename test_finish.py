...
# URL формы
FORM_VIEW_URL = "https://docs.google.com/forms/d/e/1FAIpQLSfegSLrxN8kB3NHDAUg0AeCdCfxzEIqd2DONBYkyJ9G5YIacg/viewform"
FORM_SUBMIT_URL = "https://docs.google.com/forms/d/e/1FAIpQLSfegSLrxN8kB3NHDAUg0AeCdCfxzEIqd2DONBYkyJ9G5YIacg/formResponse"
...
def get_form_params():
    try:
        ...
        return "-7987162531628068791", "0,1"  # Значения по умолчанию
...
for i in range(1, 301):
    ...
    for service in random_multi(SERVICES, 1, 3):
